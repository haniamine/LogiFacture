...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post produits_url, params: { produit: { libelle: @produit.libelle, prixHT: @produit.prixHT, tauxTVA: @produit.tauxTVA } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { libelle: @produit.libelle, prixHT: @produit.prixHT, tauxTVA: @produit.tauxTVA } }
